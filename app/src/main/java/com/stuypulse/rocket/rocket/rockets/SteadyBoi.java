...
public class SteadyBoi extends Rocket {
    ...
    _R952.getAngle().add(TARGET_ANG).sin();}else{_R952=getState();}}public void F_Q96(){if(_P506<_P507)
    {_P509=_P505;}else{_P509=_P502;}if(_P509<_P506){_P501=TARGET_HEIGHT;_P508=_R952.getPosition().y;}
    else{_P508=_R952.getVelocity().y;}}public void F_U89(){if(_P501<_P512){_P501=_P511;}if(_P501>_P510)
    {_P501=_P513;}setThrust(_P501);}public void F_U90(){setThrustAngle(Math.signum(_P519)*_P511);}protected 
    void execute(){_P516=_P511;F_T21();_P505=_P504;F_Q96();_P501-=_P508;_P516=_P511;F_T21();_P505=_P502;
    F_Q96();_P501-=_P503*_P508;F_U89();_P516=_P507;F_T21();F_U90();}public Color getColor(){return Color.magenta;}
}